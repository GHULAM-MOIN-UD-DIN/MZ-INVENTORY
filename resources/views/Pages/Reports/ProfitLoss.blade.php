    ...
    <div class="max-w-6xl mx-auto space-y-8 animate-fade-in">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <button onclick="window.print()"
                class="px-6 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-sm font-bold flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div
                class="premium-card p-8 bg-gradient-to-br from-white to-orange-50/30 dark:from-slate-900 dark:to-orange-950/10">
            ...
            <div
                ...
                <h3 class="text-3xl font-black text-slate-800 dark:text-slate-100">Rs.
                    {{ number_format($purchases + $expenses, 2) }}</h3>
                <div class="mt-4 flex items-center gap-2 text-orange-500 text-[10px] font-black uppercase">
        ...
        <div class="premium-card overflow-hidden">
            ...
            <div class="p-8 space-y-4">
                ...
                <div
                    class="flex justify-between items-center py-4 border-b-2 border-slate-200 dark:border-slate-700 bg-slate-50/30 dark:bg-slate-800/30 px-4 -mx-4 rounded-lg">
        ...
        <div class="premium-card overflow-hidden">
            <div class="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                ...
                <a href="{{ route('report.index') }}" class="text-[10px] font-black text-orange-500 uppercase">Manage
                    Expenses</a>
            </div>
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                        @forelse($recent_expenses as $exp)
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-8 py-4 text-xs font-black text-orange-500 uppercase tracking-tighter">
                                    {{ $exp->category }}</td>
                                <td class="px-8 py-4 text-xs font-bold">{{ $exp->reference }}</td>
                                <td class="px-8 py-4 text-xs font-black text-right text-orange-600">Rs.
