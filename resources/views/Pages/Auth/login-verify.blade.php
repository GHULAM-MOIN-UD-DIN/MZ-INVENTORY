...
<head>
    ...
    <title>Login 2-Step Verification | MZ Inventory Pro</title>
...
<body class="bg-[#020617] text-slate-100 min-h-screen flex items-center justify-center p-4 relative overflow-hidden font-sans antialiased">
    ...
    <div class="w-full max-w-[460px] relative z-10 animate-slide-up">
        ...
        <div class="text-center mb-8 animate-float">
            ...
            <p class="text-[10px] text-slate-400 dark:text-slate-500 uppercase tracking-[0.25em] font-bold mt-2">Security check</p>
        </div>
        ...
        <div class="glass-panel rounded-3xl p-8 sm:p-10 relative overflow-hidden">
            ...
            <form action="{{ route('login.verify') }}" method="POST" class="space-y-6">
                ...
                <!-- OTP Input -->
                <div class="space-y-2">
                    <label class="block text-xs font-bold text-slate-300 uppercase tracking-wider text-center">6-Digit Verification Code</label>
            ...
            <div class="mt-8 text-center border-t border-slate-800 pt-6 flex justify-between">
                <a href="{{ route('login') }}" class="text-xs text-slate-400 hover:text-slate-300 transition-colors font-medium">
                    <i class="fas fa-arrow-left mr-1"></i> Back to Login
                </a>
                <a href="{{ route('login') }}" class="text-xs text-orange-500 hover:text-orange-400 transition-colors font-bold">
                    Resend Code
                </a>
            </div>
        </div>
