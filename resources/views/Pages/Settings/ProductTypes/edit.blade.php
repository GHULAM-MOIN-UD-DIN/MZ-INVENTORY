...
<div class="max-w-4xl mx-auto space-y-8 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 dark:text-slate-400 mt-1">Modify existing product type.</p>
        </div>
    ...
    <div class="premium-card overflow-hidden">
        ...
        <form action="{{ route('product-type.update', $productType->id) }}" method="POST" class="p-8 space-y-8">
            @csrf
            ...
            <div class="form-group group">
                ...
                <div class="relative">
                    <input type="text" name="name" 
                           class="form-input" 
                           placeholder="e.g. Standard, Digital, Combo" value="{{ old('name', $productType->name) }}" required>
                    @error('name')
