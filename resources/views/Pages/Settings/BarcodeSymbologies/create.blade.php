...
@section('title', 'Add Barcode Symbology')
...
<div class="max-w-4xl mx-auto space-y-8 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 dark:text-slate-400 mt-1">Create a new barcode type for your products.</p>
        </div>
    ...
    <div class="premium-card overflow-hidden">
        ...
        <form action="{{ route('barcode-symbology.store') }}" method="POST" class="p-8 space-y-8">
            @csrf
            ...
            <div class="form-group group">
                ...
                <div class="relative">
                    <input type="text" name="name" 
                           class="form-input" 
                           placeholder="e.g. My Barcode, Box Barcode, EAN-13" value="{{ old('name') }}" required>
                    @error('name')
            ...
            <div class="flex flex-col sm:flex-row items-center justify-end gap-4 pt-8 border-t-2 border-slate-100 dark:border-slate-800">
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Save Symbology
                </button>
            </div>
        </form>
    </div>
