    ...
    @if(auth()->user()->role === 'cashier')
        ...
        <div class="flex flex-col gap-6 lg:gap-8">
            ...
            <div class="md:col-span-3 premium-card p-8 bg-gradient-to-tr from-orange-600 to-orange-400 text-white relative overflow-hidden group">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <h2 class="text-3xl font-black">Welcome, {{ auth()->user()->name }}!</h2>
                        <p class="text-orange-100 mt-2 text-sm max-w-md">Start ringing up orders, managing customers, and processing sales. Your session is active and secured.</p>
                    </div>
                    <a href="{{ route('pos.index') }}" class="px-6 py-4 bg-white text-orange-600 font-extrabold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center gap-3">
                        <i class="fas fa-cash-register text-lg animate-pulse"></i>
                        <span>Start Point of Sale (POS)</span>
                    </a>
                </div>
            </div>
            ...
            <div class="premium-card p-6 relative overflow-hidden group">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">My Total Revenue</p>
            ...
            <div class="premium-card p-6 relative overflow-hidden group">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">My Transactions</p>
                        <h3 class="text-2xl font-black">{{ $sales_count }} <span class="text-xs text-slate-400 font-bold uppercase tracking-tighter">Sales</span></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="premium-card p-6 relative overflow-hidden group">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Customers</p>
                        <h3 class="text-2xl font-black">{{ $total_customers }} <span class="text-xs text-slate-400 font-bold uppercase tracking-tighter">Registered</span></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="premium-card overflow-hidden">
            <div class="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                <h3 class="font-bold">My Recent Transactions</h3>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="py-8 text-center text-xs font-bold text-slate-400 uppercase tracking-wider text-center">No sales recorded.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                        ...
                        <div class="flex items-center justify-between p-3 rounded-xl bg-orange-500/5 border border-orange-500/10 group hover:bg-orange-500/10 transition-all">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-lg bg-white dark:bg-slate-800 overflow-hidden border border-slate-100 dark:border-slate-800">
                                    <img src="{{ $p->image ? cloudinary_url($p->image) : 'https://ui-avatars.com/api/?name='.urlencode($p->name).'&background=f97316&color=fff' }}" class="w-full h-full object-cover">
                                </div>
                                <div>
