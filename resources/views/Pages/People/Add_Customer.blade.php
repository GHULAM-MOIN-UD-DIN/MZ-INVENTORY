...
<div class="max-w-4xl mx-auto space-y-8 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 dark:text-slate-400 mt-1">Register a new client to your management system.</p>
        </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 
        ...
        <form action="{{ route('customer.store') }}" method="POST" class="p-8 space-y-8" id="customerForm">
            @csrf
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-3 pb-4 border-b-2 border-slate-100 dark:border-slate-800">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-slate-800 dark:text-slate-200">Personal Details</h3>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Basic identification and contact info</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="form-group group">
                        ...
                        <div class="relative">
                            <input type="text" name="phone" class="form-input" placeholder="e.g. +1 234 567 890">
                        </div>
                    </div>
            ...
            <div class="space-y-6 pt-4">
                <div class="flex items-center gap-3 pb-4 border-b-2 border-slate-100 dark:border-slate-800">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-slate-800 dark:text-slate-200">Location</h3>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Specify the primary address</p>
                    </div>
                </div>

                <div class="form-group group">
                    <label class="form-label flex items-center gap-1">Complete Address</label>
                    <div class="relative">
                        <textarea name="address" rows="3" class="form-input resize-none" placeholder="Enter full postal address..."></textarea>
                    </div>
                </div>
            </div>
