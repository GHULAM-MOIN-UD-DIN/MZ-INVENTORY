...
<div class="max-w-4xl mx-auto space-y-8 animate-fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 dark:text-slate-400 mt-1">Create accounts for Cashier or Manager roles to manage store operations.</p>
        </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 
        ...
        <form action="{{ route('user.store') }}" method="POST" class="p-8 space-y-8" id="userForm">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="form-group group">
                        ...
                        <div class="relative">
                            <input type="text" name="name" class="form-input" placeholder="e.g. Farrukh Ali" required value="{{ old('name') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group group">
                        ...
                        <div class="relative">
                            <input type="email" name="email" class="form-input" placeholder="e.g. farrukh@example.com" required value="{{ old('email') }}">
                        </div>
                    </div>

                    <div class="form-group group">
                        <label class="form-label flex items-center gap-1">Password <span class="text-orange-500">*</span></label>
                        <div class="relative">
            ...
            <div class="space-y-6 pt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <label class="role-card cursor-pointer block">
                        <input type="radio" name="role" value="cashier" class="hidden" {{ old('role', 'cashier') === 'cashier' ? 'checked' : '' }}>
